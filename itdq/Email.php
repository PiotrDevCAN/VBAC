...
class Email
{
    ...
    static function send_mail($to, $cc, $subject, $message, $replyto, $log = true)
    {
        ...
        if ($_SESSION['email']) {
            ?>
            <div id='<?php echo "email" . $rand;?>' style='display:block;' /><H3><?php echo $rand ?> If this message remains visible or you see a further message : 'Fatal Error: Maximum execution time.....' please contact <a href='maito:piotr.tajanowicz@ocean.ibm.com'>ITDQ Application Support</a> urgently and inform them.</H3></div>
           <?php
