...
$pesEmail.= 'We have recently made changes to our LBG contracts, this includes the requirement for PES revalidation.  It is now within 8 weeks of your revalidation date.';
$pesEmail.= 'If you would like to retain your LBG PES, please see below the requirements.';
$pesEmail.= 'Please return the following attached documents:';
$pesEmail.= '<ul>';
