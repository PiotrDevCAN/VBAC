...
$pesEmail.= '<li>Fully completed ODC application form <b>(Attached)</b>, with full 5 years address history (please return this as <b>one separate .pdf document with a physical signature</b> - Please do not have this document certified by another IBM\'er) - Please mention (open seat number from vBAC) in the section for IBM Emp.No.</li>';
