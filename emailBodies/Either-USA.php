...
$pesEmail.= '<li>An email from your IBM Manager confirming your IBM Start Date <b>OR</b> a screen print of the relevant page of the "About You" system<br/><span style="color:blue"><b>Further information and evidence</b> will be required if it is less than 5 years ago</span></li>';
...
$pesEmail.= '<li>Full completed Overseas consent form <b>(Attached)</b>, to allow us to process the Criminal Records Check</li>';
$pesEmail.= '</ul>';
...
$pesEmail.= '<p>If you have any questions, you do not have any of the listed documents or are unsure about the process please contact the PES Team on <a href=\'mailto:&&pesTaskId&&\'>&&pesTaskId&&</a></p>';
...
$pesEmailPattern = array('/&&firstName&&/','/&&pesTaskId&&/');