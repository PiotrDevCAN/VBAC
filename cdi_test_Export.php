...
$sendResponse = BlueMail::send_mail(array('piotr.tajanowicz@ibm.com'), 'orderit export', 'Find attached CSV',
    'piotr.tajanowicz@ibm.com',array(),array(),true,array(array('filename'=>'test.txt','content_type'=>'text/plain','data'=>$base64EncodedData)));
