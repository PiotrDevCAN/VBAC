...
ALTER TABLE "ROB_DEV".ASSET_REQUESTS_HISTORY ADD RESTRICT ON DROP;

alter table ROB_DEV.ASSET_REQUESTS DROP VERSIONING;

"ROB_DEV".ASSET_REQUESTS

alter table "ROB_DEV".ASSET_REQUESTS drop column "ORDERIT_RESPONDED" DISABLE ARCHIVE;	

alter table "ROB_DEV".ASSET_REQUESTS DISABLE ARCHIVE;	 
commit;
	 
	 
	 
	 
CALL SYSPROC.ADMIN_CMD ('REORG TABLE ROB_DEV.ASSET_REQUESTS_HISTORY');
