    ...
    static function returnPesEventsTable($records='Active',$returnResultsAs='array'){
        ...
        switch (trim($records)){
            case self::PES_TRACKER_RECORDS_ACTIVE :
                $pesStatusPredicate = "  P.PES_STATUS in('" . personRecord::PES_STATUS_REQUESTED . "','" . personRecord::PES_STATUS_INITIATED. "','" . "','" . personRecord::PES_STATUS_RESTART. "','" . personRecord::PES_STATUS_PROVISIONAL. "','" . personRecord::PES_STATUS_RECHECK_REQ . "','" . personRecord::PES_STATUS_MOVER . "') ";
                break;
            case self::PES_TRACKER_RECORDS_ACTIVE_PLUS :
                $pesStatusPredicate = "  P.PES_STATUS in('" . personRecord::PES_STATUS_REQUESTED . "','" . personRecord::PES_STATUS_INITIATED. "','" . "','" . personRecord::PES_STATUS_RESTART. "','". personRecord::PES_STATUS_PROVISIONAL. "','" . personRecord::PES_STATUS_RECHECK_REQ . "','" . personRecord::PES_STATUS_REMOVED. "','" . personRecord::PES_STATUS_CLEARED. "','" . personRecord::PES_STATUS_MOVER . "') ";
                break;
            case self::PES_TRACKER_RECORDS_ACTIVE_REQUESTED :
                $pesStatusPredicate = "  P.PES_STATUS in('" . personRecord::PES_STATUS_REQUESTED . "','" . personRecord::PES_STATUS_INITIATED. "','" . "','" . personRecord::PES_STATUS_RESTART. "','" . personRecord::PES_STATUS_RECHECK_REQ . "','" . personRecord::PES_STATUS_MOVER . "') ";
                break;
            ...
            case self::PES_TRACKER_RECORDS_NOT_ACTIVE :
                $pesStatusPredicate = " P.PES_STATUS not in ('" . personRecord::PES_STATUS_REQUESTED . "','" . personRecord::PES_STATUS_INITIATED. "','" . "','" . personRecord::PES_STATUS_RESTART. "','" . personRecord::PES_STATUS_PROVISIONAL. "','" . personRecord::PES_STATUS_RECHECK_REQ . "','" . personRecord::PES_STATUS_MOVER . "')  ";
