...
//                             </table>';
    ...
    private static $pesClearedProvisionalEmail = '<style>.centreRed:   text-align:center;  color:red;</style>
                                              <p>Hello &&candidate&&,</p>
                                              ...
                                              <p class=\'centreRed\' ><span style=\'text-align:center;color:red\'>True & Certified Copy<br/>Name of certifier  in BLOCK CAPITALS<br/>IBM Serial number of certifier<br/>Certification Date<br/>Signature of certifier<br/></span></p>
...
//     }
    ...
    function initiateOffboarding(){
        ...
        $personTable->flagOffboarding($this->CNUM, $this->REVALIDATION_STATUS,$this->NOTES_ID);
    }
