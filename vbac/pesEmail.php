...
//         ob_clean();
    ...
    static function notifyPesTeamOfOffboarding($cnum){
        ...
        return BlueMail::send_mail(array('LBGVETPR@uk.ibm.com'), "vbac Offboarding  - $cnum : $notesId", $pesEmail,'LBGVETPR@uk.ibm.com');
    }
    ...
    static function notifyPesTeamOfOffStopRequest($cnum){
        $loader = new Loader();
        $now = new \DateTime();
        $pesEmail = null;          // Will be overridden when we include_once from emailBodies later.
