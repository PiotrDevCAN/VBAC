function saveRegularBoarding(mode, form, saveButton, initiatePesButton, table) {
    ...
    if (formValid) {
        ...
        var allDisabledFields = $("input:disabled").not("#saveRegularBoarding");
        ...
        $.ajax({
            url: "ajax/saveBoardingRegularForm.php",
            type: "POST",
            data: formData,
...
export { saveRegularBoarding as default };