...
let editEntryBox = await cacheBustImport('./modules/boxes/person/editEntryBox.js');
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (resultObj.success == true) {
                            ...
                            if (skillsetId) {
                                $("#skill_set_id").val(skillsetId.trim()).trigger("change");
                            }

                            var proposedLeavingDate = resultObj.data.PROPOSED_LEAVING_DATE;
                            if (pesRecheckDate) {
                                $("#proposed_leaving_date").val(proposedLeavingDate.trim());
                            }
...
const EditEntryBox = new editEntryBox(OnBoarding);
