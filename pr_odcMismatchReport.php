...
->setSubject('ODC Location Mismatch')
->setDescription('Records where the ODC_ACCESS entry implies they work in an ODC Location, but their LGB_LOCATION doesn\'t relect this. And Vice Versa')
...
try {
    ...
    if($rs){
        ...
        if($recordsFound){
            ...
            $spreadsheet->getActiveSheet()->setTitle('Location Mismatch');
            DbTable::autoSizeColumns($spreadsheet);
